    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section className="mx-auto max-w-7xl px-6 pt-12 pb-20 text-center">
          ...
          <p className="mx-auto mt-4 text-xs font-semibold tracking-[0.25em] text-primary uppercase select-none">
            Connect Beyond the Screen.
          </p>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            Real-time polls, live word clouds, and instant quizzes. Students join with a QR — no
          ...
          <div className="mx-auto mt-10 flex max-w-md flex-col gap-3">
            <form onSubmit={handleJoin} className="glass flex items-center gap-2 rounded-2xl p-2">
              ...
              />
              <Button type="submit" className="gradient-bg font-semibold">
                Join
              </Button>
            </form>
            ...
            {[
              {
                icon: BarChart3,
                title: "Live Polls",
                desc: "MCQ voting with instant percentage bars.",
                color: "text-[color:var(--primary)]",
              },
              {
                icon: Cloud,
                title: "Word Clouds",
                desc: "Watch student thinking form in real-time.",
                color: "text-[color:var(--accent-emerald)]",
              },
              {
                icon: Zap,
                title: "Quizzes",
                desc: "Timed questions with a live leaderboard.",
                color: "text-[color:var(--primary-glow)]",
              },
            ].map((f) => (
              <div
                key={f.title}
          ...
          <div className="mx-auto mt-16 flex max-w-4xl flex-wrap items-center justify-center gap-8 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              <Users className="h-4 w-4" /> Unlimited participants
            </div>
            <div className="flex items-center gap-2">
              <Zap className="h-4 w-4" /> Instant realtime updates
            </div>
            <div className="flex items-center gap-2">
              <Sparkles className="h-4 w-4" /> Zero-signup for students
            </div>
          </div>
        </section>
